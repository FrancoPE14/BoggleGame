    ...
    <div className="min-h-screen bg-zinc-50" style={{ color: "#18181b" }}>
      <main className="mx-auto w-full max-w-4xl px-4 py-8">
        <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <section className="mb-5">
            <h2 className="mb-2 text-xl font-semibold" style={{ color: "#18181b" }}>Core Gameplay</h2>
          ...
          <section className="mb-5">
            <h2 className="mb-2 text-xl font-semibold" style={{ color: "#18181b" }}>
              Optional / Advanced Features
            </h2>
            <p className="mb-2 leading-7" style={{ color: "#3f3f46" }}>
          ...
          <section>
            <h2 className="mb-2 text-xl font-semibold" style={{ color: "#18181b" }}>Notes</h2>
            <p className="leading-7" style={{ color: "#3f3f46" }}>
